...
请参阅 [[https://www.netdevconf.org/0x13/session.html?talk-veth-xdp][Veth XDP: XDP for containers]] 演讲，其中描述了此问题背后的原因。
...
[[https://lwn.net/Articles/728146][此补丁系列]]。使用示例可以在
...
[[#sending-packets-back-to-the-interface-they-came-from][将数据包发送回它们来自的接口]] 部分所述。
