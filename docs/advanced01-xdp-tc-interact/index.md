...
XDP 和 TC BPF 程序代码在：[samples/bpf/xdp2skb_meta_kern.c](https://github.com/torvalds/linux/blob/master/samples/bpf/xdp2skb_meta_kern.c)。
通过 iproute2 加载 XDP 和 TC 的 shell 脚本放在
[xdp2skb_meta.sh](https://github.com/torvalds/linux/blob/master/samples/bpf/xdp2skb_meta.sh)。

### XDP CPU 重定向解决 TC 锁定


一个现实世界的问题是流量整形导致 TC 根 qdisc 锁上的锁竞争
（例如 [Google 的服务器遇到了这个问题](http://vger.kernel.org/lpc-bpf2018.html#session-1) 另见 [文章](https://doi.org/10.1145/2785956.2787478)）。
...
通过 [内核提交 74e31ca850c1](https://github.com/torvalds/linux/commit/74e31ca850c1)。
